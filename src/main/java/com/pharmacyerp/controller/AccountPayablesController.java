...
public class AccountPayablesController implements Initializable {
    ...
    private void loadDummyData() {
        records.clear();
        java.util.List<com.pharmacyerp.dao.AccountDAO.AccountRow> data = com.pharmacyerp.dao.AccountDAO.getPayables();

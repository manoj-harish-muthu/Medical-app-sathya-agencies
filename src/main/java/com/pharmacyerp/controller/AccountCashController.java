...
public class AccountCashController implements Initializable {
    ...
    private void loadDummyData() {
        ...
        if (dpFrom.getValue() != null && dpTo.getValue() != null) {
            java.util.List<com.pharmacyerp.dao.AccountDAO.AccountRow> data = com.pharmacyerp.dao.AccountDAO.getIncomingPayments("CASH", dpFrom.getValue(), dpTo.getValue());
